...
Template para documentação de writeups e relatórios. Você pode utilizar a versão em LaTeX ou a versão do Google Docs.

## Como usar

Escolha a plataforma de sua preferência e faça uma cópia do arquivo original para a sua conta para começar a editar.

### 1. Google Docs
Acesse o link abaixo e vá em **Arquivo > Fazer uma cópia** (File > Make a copy) para usar o template:
- [Abrir Template no Google Docs](https://docs.google.com/document/d/1OeWmSb1gI3ApvcNDmAG2shKCyIsYGPi-_FY2F3WYHc8/edit?usp=sharing)

### 2. Overleaf (LaTeX)
Acesse o link abaixo e vá em **Menu > Copy Project** para salvar o projeto na sua conta:
- [Abrir Template no Overleaf](https://www.overleaf.com/read/cmhdffxbgtkm#115340)

## Exemplos dos Templates em PDF

Veja como fica o resultado final de cada template:
- [Exemplo - Versão Google Docs](./pdf/exemplo_docs.pdf)
- [Exemplo - Versão LaTeX](./pdf/exemplo_latex.pdf)
...
Para mantermos a organização, por favor, siga o padrão de nomenclatura abaixo antes de nos enviar o seu arquivo PDF:

**Formato padrão:** `ctf_writeup_SEUNOME.pdf`
